...
$tmpl = array (
'table_open'          => '<table id="report" border="0" cellpadding="4" cellspacing="0">',
...
if (isset($array_report))
{
	foreach($array_report as $index=>$value)
	{
		...
		$this->table->add_row(form_checkbox($chk_input), $value['Inv_id'], $value['Name'], $value['Price'], $value['Amortization'], $value['Time'], $value['Number'], $value['Num_room'], $value['Family'], $value['Comment']);
	}
}
